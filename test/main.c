...
static const struct test tests[] = {
	...
	TEST(test_call_datachannel),
	TEST(test_call_datachannel_late),
	TEST(test_call_datachannel_nonmux),
	TEST(test_call_datachannel_rejected),
	...
	TEST(test_message),
	TEST(test_media_transport_adopt_reconfigure),
	TEST(test_media_transport_fresh_gather),
	TEST(test_pc_transport_role_resolution),
	TEST(test_menc_rebind_destructor_callback),
	TEST(test_mnat_media_attempt),
	TEST(test_mnat_media_restart),
	TEST(test_network),
	TEST(test_bundle_legacy_forwarding),
	TEST(test_bundle_atomic_publication),
	TEST(test_bundle_stream_teardown),
	TEST(test_bundle_self_callback_teardown),
	TEST(test_bundle_wire_callback_teardown),
	TEST(test_peerconn),
	TEST(test_peerconn_data_runtime),
	TEST(test_peerconn_answer_retry),
	TEST(test_peerconn_restart_shadow),
	TEST(test_peerconn_rtp_restart),
	TEST(test_peerconn_remote_split),
	TEST(test_peerconn_late_data),
	TEST(test_menc_transport_identity),
	TEST(test_bundle_route_transaction),
	TEST(test_bundle_disjoint_routes),
	TEST(test_play),
	TEST(test_stunuri),
	TEST(test_ua_alloc),
	TEST(test_ua_cuser),
